...
class DeliveryOrderAdmin: UIViewController , UITableViewDelegate , UITableViewDataSource , UISearchBarDelegate , UISearchResultsUpdating {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = table.dequeueReusableCell(withIdentifier: "deliverycell", for: indexPath) as! OrderDisplayCell
...
//                self.viewDidAppear(true)
//            }
//        }, errorHandlerqueryBuilder: queryBuilder, responseHandler: { (items) in
//            self.navbarIndicator.stopAnimating()
//
//            for item in items! {
//                if let orderitem = item as? OrderItems {
